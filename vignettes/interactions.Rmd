...
The `linearize` function will select all interactions involving `x` and return a `RangedSummarizedExperiment` object, 
    where the genomic interval for each row in the object corresponds to the *other* (i.e., non-`x`) region involved in each selected interaction.
